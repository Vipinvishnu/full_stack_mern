  ...
  const handleRegister = async (e) => {
    ...
    if (!userName || !email || !password) {
      ...
      if (result.status === 200) {
        toast.success(
          `${result.data.userName} your account created successfully`,
          {
            position: "top-center",
            autoClose: 5000,
            hideProgressBar: false,
      ...
      <div className="w-50 container bg-light shadow-lg mb-5 p-5 mt-5 ">
        <Row>
          <Col>
            ...
            >
              {" "}
              <i class="fa-solid fa-circle-arrow-left fa-beat"></i> Back To Home
            </Link>
            <img
              className="w-100"
              src={
                isRegisterForm
                  ? "https://i.postimg.cc/PrnQZTvq/project2.jpg"
                  : " https://i.postimg.cc/8k0BKT6D/project1.webp "
              }
              alt=" "
            />
          </Col>
          <Col className="p-3 mt-4">
            ...
            <div className="mt-5">
              ...
              {emailValid && <p className="text-primary">Email is not valid</p>}
